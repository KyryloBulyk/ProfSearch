		...
		<div>
			<div className='py-24 px-4 max-w-7xl my-0 mx-auto'>
				...
				<div className='flex pt-10'>
					<input
						type='text'
						className='rounded-l-lg border border-zinc-300 p-2 md:p-4 text-sm md:text-base w-full focus:outline-blue-500 -mr-1 duration-100'
						placeholder={t('header.inputPlaceholder')}
						value={search}
						onChange={(e) => setSearch(e.target.value)}
					/>
					<button
						className='bg-blue-500 text-white p-2 text-sm md:text-base rounded-r-lg w-52'
